...
2. S13 的真实游戏、休眠/锁屏、混合权限、多显示器/DPI 和长时间桌面矩阵由项目所有者执行；它不影响 S00–S12 自动代码门禁结论，但影响最终公开发布置信度。

因此，S00–S12 的可执行代码问题及最新上游人工处置均已完成；项目仍不能宣称“可公开发布”，直到项目所有者选择许可证并完成真实桌面/游戏矩阵。
